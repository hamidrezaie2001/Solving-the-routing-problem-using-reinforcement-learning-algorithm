...
def get_next_action(current_row_index1, current_column_index1, current_row_index2, current_column_index2, 
                    current_row_index3, current_column_index3, current_row_index4, current_column_index4,
                    current_row_index5, current_column_index5,epsilon=0.75):
    if np.random.random() < epsilon:
        return np.argmax(q_values[current_row_index1, current_column_index1, current_row_index2, current_column_index2, 
                      current_row_index3, current_column_index3, current_row_index4, current_column_index4,
                    current_row_index5, current_column_index5])
    else:
...
def roll(m, r, c, direction):
    if abs(r - getFarestZero(m, r, c, 0)) < 1 and abs(c - getFarestZero(m, r, c, 2)) < 1 and abs(r - getFarestZero(m, r, c, 1)) < 1 and abs(c - getFarestZero(m, r, c, 3)) < 1:
        vert_value = random.choice([3, 4, 5, 6, 7])
...
def convert(old_row_index1, old_column_index1, old_row_index2, old_column_index2,
            old_row_index3, old_column_index3 ,old_row_index4, old_column_index4,
            old_row_index5, old_column_index5,
            vert_value, matrix):
    
    if vert_value == 3:
        return find(vert_value, matrix)[0] ,find(vert_value, matrix)[1] ,old_row_index2, old_column_index2, old_row_index3, old_column_index3, old_row_index4, old_column_index4 , old_row_index5, old_column_index5        
    elif vert_value == 4:
        return old_row_index1, old_column_index1,find(vert_value, matrix)[0] ,find(vert_value, matrix)[1],old_row_index3, old_column_index3, old_row_index4, old_column_index4 , old_row_index5, old_column_index5          
    elif vert_value == 5:
        return old_row_index1, old_column_index1,old_row_index2, old_column_index2,find(vert_value, matrix)[0] ,find(vert_value, matrix)[1], old_row_index4, old_column_index4 , old_row_index5, old_column_index5  
    elif vert_value == 6:
        return old_row_index1, old_column_index1, old_row_index2, old_column_index2, old_row_index3, old_column_index3, find(vert_value, matrix)[0] ,find(vert_value, matrix)[1], old_row_index5, old_column_index5  
    elif vert_value==7:
        return old_row_index1, old_column_index1, old_row_index2, old_column_index2, old_row_index3, old_column_index3, old_row_index4, old_column_index4 ,find(vert_value, matrix)[0] ,find(vert_value, matrix)[1]  
...
for episode in range(10000):
    ...
    vert_value = random.choice([3, 4, 5, 6])
    ...
    Index = find(6, matrix)            
    row_index4, column_index4 = Index[0], Index[1]
    Index = find(7, matrix)            
    row_index5, column_index5 = Index[0], Index[1]    
    ...
    counter = 0
    mat = np.array(matrix)
    matcounter = environment_rows
    while not is_terminal_state():
    # choose which action to take (i.e., where to move next)
        action_index = get_next_action(row_index1, column_index1, row_index2, column_index2,
                                       row_index3, column_index3, row_index4, column_index4,
                                       row_index5, column_index5, epsilon)
        ...
        Index = find(6, matrix)            
        old_row_index4, old_column_index4 = Index[0], Index[1]
        Index = find(7, matrix)            
        old_row_index5, old_column_index5 = Index[0], Index[1]
        ...
        if np.all(mat[matcounter-environment_rows : matcounter, :] == mat[matcounter:matcounter +environment_rows, :]):
            break
        ...
        old_q_value = q_values[old_row_index1, old_column_index1,old_row_index2, old_column_index2,
                                       old_row_index3, old_column_index3, old_row_index4, old_column_index4,old_row_index5, old_column_index5, action_index]
        row_index1, column_index1, row_index2, column_index2, row_index3, column_index3, row_index4, column_index4, row_index5, column_index5 = convert(old_row_index1, old_column_index1, old_row_index2, old_column_index2, old_row_index3, old_column_index3, old_row_index4, old_column_index4, old_row_index5, old_column_index5, vert_value, matrix)
        temporal_difference = reward + (discount_factor * np.max(q_values[row_index1, column_index1, row_index2, column_index2,
                                       row_index3, column_index3, row_index4, column_index4, row_index5, column_index5])) - old_q_value

        #update the Q-value for the previous state and action pair
        new_q_value = old_q_value + (learning_rate * temporal_difference)
        q_values[old_row_index1, old_column_index1, old_row_index2, old_column_index2,
                                       old_row_index3, old_column_index3, old_row_index4, old_column_index4,old_row_index5, old_column_index5,  action_index] = new_q_value
